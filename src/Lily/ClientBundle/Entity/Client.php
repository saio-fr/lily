...
class Client
{
     ...
     * Set config
     *
     * @param \Lily\ClientBundle\Entity\Config $config
     * @return Client
     */
    public function setConfig(\Lily\ClientBundle\Entity\Config $config = null)
    {
        $this->config = $config;
     ...
     * Get config
     *
     * @return \Lily\ClientBundle\Entity\Config 
     */
