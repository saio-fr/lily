...
use Lily\BackOfficeBundle\Entity\AviConfig;
use Lily\BackOfficeBundle\Entity\ChatConfig;
use Lily\BackOfficeBundle\Entity\RedirectionsConfig;
...
class ClientController extends BaseController
{
    ...
    public function addAction(Request $request) {
        ...
        $config->setChat(new ChatConfig());
        $config->setAvi(new AviConfig());
        $config->setRedirections(new RedirectionsConfig());
