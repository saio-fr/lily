...
function loginCallback(response) {
  ...
  if(response.status != 'connected') {
    top.location.href = 'https://www.facebook.com/appcenter/saio-appli-test/';
    //https://apps.facebook.com/saio-appli-test/
  }
}
...
function sendRequest(to, message, callback) {
  var options = {
    method: 'apprequests'
  };
  if(to) options.to = to;
...
function sendFeed(caption, callback) {
  FB.ui({ method: 'feed',
    caption: caption,
    picture: '/image/lily.png',
    name: 'Checkout this awesome app!'
  }, callback);
}
