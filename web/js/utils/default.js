define(function(require) {
  ...
  Utils.serializeObject = function(el) {
    var a = {},
      b = function(b, c) {
        var d = a[c.name];
        "undefined" != typeof d && d !== null ? $.isArray(d) ? d.push(c.value) : a[c.name] = [d,
    ...
    reader.onload = (function(aImg) {
      return function(e) {
        ...
        if (allowedTypes.indexOf(format) >= 0 && e.total < (limit * 1024 * 1024)) {
          ...
          description.html('<span>Wrong format or size! Accepted formats: ' + allowedTypes.join(
            ', ') + '. Size limit is: ' + limit + 'MB</span>');
        }
